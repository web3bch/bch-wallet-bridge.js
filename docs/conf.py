...
latex_documents = [
    (master_doc, 'web3bch.tex', u'web3bch Documentation',
     u'Taiki Uchida, Shun Usami, Akifuji Fujita', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'web3bch', u'web3bch Documentation',
     author, 'web3bch', 'One line description of project.',
     'Miscellaneous'),
]
